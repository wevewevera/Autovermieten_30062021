...
{
    class ErstelleMittelklasseBefehl
    {
        public static Mittelklasse erstelleMittelklasse()
        {
            ...
            return new Mittelklasse(ps, farbe, kennzeichen, marke, kilometerstand, preisProTag, miettage);
        }
    }
}
